public class PhoneNumber
{
    ...
    {
        String formattedNumber = new StringBuilder().append("+").append(countryCode).append(companyNumber)
                .append("-").append(remainingNumbers.substring(0,3)).append("-").append(remainingNumbers.substring(3,remainingNumbers.length())).toString();
